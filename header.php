      ...
      <div class="container">
        <div class="top-bar__wrapper">
          <div class="top-bar__content top-bar__content--left">
            <a href="tel:<?php echo esc_html($global_phone_number);?>" class="top-bar__phone"><?php echo esc_html($global_phone_number_display);?></a>
                ...
                <?php foreach($global_social_media as $key => $item):?>
                  <li>
                    <a href="<?php echo esc_url_raw($item['link']);?>" target="_blank">
                      <?php 
                        if(!empty($item['additional_icon'])) {
                          echo wp_get_attachment_image($item['additional_icon'], 'nav-sm', '', ['class' => 'object-fit-contain']);
                        }
                      ?>
                    </a>
                  </li>
    ...
    <div class="container">
      <nav class="nav <?php if(!is_front_page()) { echo 'nav--subpage'; } ?>">
        ...
        <div class="nav__content <?php if(!is_front_page()) { echo 'nav__content--subpage'; } ?>">
          ...
          <?php endif;?>
          <?php if(!empty($header_button) && (strpos($_SERVER['REQUEST_URI'], 'produkt') === false)):?>
