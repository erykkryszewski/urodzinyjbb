...
<div class="cookies">
	...
	<?php else:?>
		<p><?php _e('Używamy plików cookies, aby zapewnić najlepszą jakość korzystania z naszej witryny. Jeśli będziesz nadal korzystać z tej witryny, założymy, że zgadzasz się z tym oraz akceptujesz naszą', 'ercodingtheme');?>&nbsp;<a href="/polityka-prywatnosci"><?php _e('Politykę prywatności', 'ercodingtheme');?></a>.</p>
	<?php endif;?>
				...
				<div class="col-12 col-lg-4">
					<div class="footer__column">
						<div class="footer__navigation">
							...
							<?php endif;?>
							<?php if(!empty($footer_second_column_navigation)):?>
								<ul>
				...
				<div class="col-12 col-lg-4">
					<div class="footer__column">
						<div class="footer__navigation">
							...
							<?php endif;?>
							<?php if(!empty($footer_fourth_column_navigation)):?>
								<ul>
	...
	<div class="bottom-bar">
		<div class="container">
			<div class="bottom-bar__wrapper">
				<p><?php _e('Copyright', 'ercodingtheme');?> © <?php echo date("Y"); ?>&nbsp;<?php _e('JBB Team', 'ercodingtheme');?></p>
